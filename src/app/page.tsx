...
export default async function HomePage() {
  ...
  return (
    <>
      <Script
        defer
        src="https://5taste.mysounskyserver.net/mapytsoun.js"
        data-website-id="87d47e70-0239-40c7-92a7-e7f55859d1cf"
      />
          ...
          <footer className="mt-16 border-t border-white/10 pb-6 pt-8 text-center text-white/70">
            ...
            <div className="flex justify-center space-x-6">
              <a
                ...
                className="transition-colors hover:text-[hsl(280,100%,70%)]"
              >
                Facebook
              </a>
              <a
