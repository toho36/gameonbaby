...
/*
  To run this script:
  1. npx ts-node src/scripts/create-registration-history-table.ts
  
  This script creates the RegistrationHistory table directly in the database
  if it doesn't already exist, bypassing Prisma's migration system.
*/
